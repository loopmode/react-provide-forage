...
var ProvideForage = function (_PureComponent) {
    (0, _inherits3.default)(ProvideForage, _PureComponent);
    ...
    (0, _createClass3.default)(ProvideForage, [{
        ...
        value: function render() {
            ...
            return _react2.default.Children.map(this.props.children, function (child) {
                return _react2.default.cloneElement(child, (0, _extends4.default)({}, _this2.state.storageValues, _this2.state.propagationValues));
            });
        }
    }, {
